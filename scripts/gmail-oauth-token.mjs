...
console.log('\nGmail OAuth refresh token generated.\n');
console.log('Add this to .env.local and Netlify production env vars as GOOGLE_REFRESH_TOKEN:\n');
...
function getAuthCode() {
  ...
  if (!codeValue) {
    console.error('Usage: npm run gmail:exchange-code -- <code>');
